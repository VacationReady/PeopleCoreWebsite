...
function DemoEmailSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await requestDemoAccess(email)
            ...
            <AnimatePresence mode="wait">
              {isSubmitted ? (
                ...
                <motion.form 
                  ...
                  className="bg-white/10 backdrop-blur-md rounded-xl p-2 border border-white/20"
                >
                  ...
                  {error && (
                    <p className="text-red-300 text-xs mt-2 px-2">{error}</p>
                  )}
                </motion.form>
              )}
            </AnimatePresence>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] mb-8">
                ...
                <br />
                <span className="text-gray-900">built for New Zealand employers</span>
              </h1>
