...
const XeroIcon = () => (
  <svg viewBox="0 0 24 24" className="w-full h-full">
    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 16.394l-2.106-3.447 2.106-3.447a.75.75 0 00-.642-1.125h-.006a.75.75 0 00-.642.375l-1.854 3.072-1.854-3.072a.75.75 0 00-.642-.375h-.006a.75.75 0 00-.642 1.125l2.106 3.447-2.106 3.447a.75.75 0 00.642 1.125h.006a.75.75 0 00.642-.375l1.854-3.072 1.854 3.072a.75.75 0 00.642.375h.006a.75.75 0 00.642-1.125zM8.25 8.625a.75.75 0 00-.75.75v5.25a.75.75 0 001.5 0v-5.25a.75.75 0 00-.75-.75z" fill="#13B5EA"/>
  </svg>
)

const OutlookIcon = () => (
  <svg viewBox="0 0 24 24" className="w-full h-full">
    <path d="M24 7.387v10.478c0 .23-.08.424-.238.576-.16.154-.352.234-.578.242h-8.4v-6.9l1.83 1.26c.078.054.168.08.27.08.1 0 .186-.026.258-.08l6.62-4.5a.478.478 0 01.238-.066V7.387z" fill="#0072C6"/>
    <path d="M15.9 8.4l-1.116.762-6.9-4.5V3.6c0-.23.08-.424.238-.576.16-.154.352-.234.578-.242h15.516c.226.008.418.088.578.242.158.152.238.346.238.576v.66L15.9 8.4z" fill="#0072C6"/>
    <path d="M8.4 5.4v13.2c0 .23-.08.424-.238.576-.16.154-.352.234-.578.242H.816c-.226-.008-.418-.088-.578-.242C.08 19.024 0 18.83 0 18.6V5.4c0-.23.08-.424.238-.576.16-.154.352-.234.578-.242h6.768c.226.008.418.088.578.242.158.152.238.346.238.576z" fill="#0072C6"/>
    <ellipse cx="4.2" cy="12" rx="2.4" ry="3" fill="white"/>
  </svg>
)

const TeamsIcon = () => (
  <svg viewBox="0 0 24 24" className="w-full h-full">
    <path d="M20.625 6.375h-3.75v-1.5a1.875 1.875 0 00-1.875-1.875h-6a1.875 1.875 0 00-1.875 1.875v1.5H3.375A1.875 1.875 0 001.5 8.25v9.375a1.875 1.875 0 001.875 1.875h17.25a1.875 1.875 0 001.875-1.875V8.25a1.875 1.875 0 00-1.875-1.875z" fill="#5059C9"/>
    <circle cx="17.25" cy="4.5" r="2.25" fill="#5059C9"/>
    <path d="M14.25 9.75h-4.5v6h4.5v-6z" fill="white"/>
    <path d="M9.75 9.75h-3v4.5h3v-4.5z" fill="white" fillOpacity="0.8"/>
    <circle cx="12" cy="7.5" r="1.5" fill="white"/>
    <circle cx="8.25" cy="8.25" r="1.125" fill="white" fillOpacity="0.8"/>
  </svg>
)
